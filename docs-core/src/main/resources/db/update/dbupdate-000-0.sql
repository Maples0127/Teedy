...
create table T_USER_CHAT (UCH_ID_C VARCHAR(36) NOT NULL,UCH_SENDER_NAME_C VARCHAR(50) NOT NULL,UCH_RECEIVER_NAME_C VARCHAR(50) NOT NULL,UCH_MESSAGE_C VARCHAR(4000) NOT NULL,UCH_SENDDATE_D DATETIME NOT NULL,PRIMARY KEY (UCH_ID_C),);
