...
create table T_USER_REGISTRATION (URQ_ID_C VARCHAR(36) NOT NULL,URQ_USERNAME_C VARCHAR(50) NOT NULL,URQ_EMAIL_C VARCHAR(100) NOT NULL,URQ_STATUS_C VARCHAR(20) NOT NULL DEFAULT 'pending',URQ_CREATEDATE_D DATETIME NOT NULL,URQ_DELETEDATE_D DATETIME,URQ_DISABLEDATE_D DATETIME,PRIMARY KEY (URQ_ID_C) );
